...
def main() -> int:
    ...
    if 'base.outcome = safe_outcome' not in safe_text or 'base.make_features = safe_make_features' not in safe_text:
        fail('safe runner does not install both required guards', failures)
